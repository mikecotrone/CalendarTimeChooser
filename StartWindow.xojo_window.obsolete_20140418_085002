...
Begin Window StartWindow
   ...
   Placement       =   0
   Resizeable      =   False
   Title           =   "Calendar / Time Chooser Project"
   Visible         =   True
   Width           =   521
   Begin TextArea TextArea1
      ...
      Width           =   481
   End
   Begin PushButton LaunchBothButton
      AutoDeactivate  =   True
      Bold            =   False
      ButtonStyle     =   "0"
      Cancel          =   False
      ...
      Width           =   94
   End
   Begin PushButton LaunchCalendarButton
      AutoDeactivate  =   True
      Bold            =   False
      ButtonStyle     =   "0"
      Cancel          =   False
      ...
      Width           =   94
   End
   Begin PushButton LaunchTimeButton
      AutoDeactivate  =   True
      Bold            =   False
      ButtonStyle     =   "0"
      Cancel          =   False
   ...
   Begin Label Label1
      ...
      TabIndex        =   4
      TabPanelIndex   =   0
      Text            =   "Please Choose Your Chooser :)"
      TextAlign       =   1
      TextColor       =   &c00000000
      TextFont        =   "System"
      TextSize        =   0.0
...
#tag Events LaunchBothButton
	...
	#tag EndEvent
#tag EndEvents
#tag Events LaunchCalendarButton
	#tag Event
		Sub Action()
		  CalendarWindow.Close
